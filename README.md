...
| Anda Liang      | CS    | GitHub, Networking, Coding            |
| Kevin Pan       | CS    | Networking, Coding                    |
| Luka Buskivadze | CS    | Networking, Coding                    |

## Gameplay Instructions

Welcome to the game! Here are some instructions to get you started and help you navigate through the gameplay:

Build Instructions: Reference the main branch in our repository for the latest updates to our game. Go to build settings and select both the lobby & multiplayer scenes, to build and run. This will open into the lobby with the main menu. 
...
## Project Poster
![VR Project Poster](https://github.com/WilliamStar007/Goalie-Wars/assets/89805831/beab49ea-7387-4665-9a25-fde4d77b3648)

## Documentation
<details>
<summary><strong>General Design</strong></summary>
...
- **Immediacy:** Placing the user directly in the goalie position immediately immerses them at the core of the game, aligning with the game’s focus on goalkeeping duels.
